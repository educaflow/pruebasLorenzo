package com.educaflow.common.util.mapper;
                ...
                try {
                    ...
                    if (ScalarMapper.isScalarType(propertyDescriptor.getPropertyType())) {
                        ...
                        if ((rawValue == null) && (valueDest == null)) {
                            ...
                            valueDest = ((Class<? extends Model>) propertyDescriptor.getPropertyType()).newInstance();
                        ...
                        if ((listSource == null) && (listTarget == null)) {
                            ...
                            for (Object rawValue : listSource) {
                                Model itemValue = ((Class<? extends Model>) tipoListaClass).newInstance();
